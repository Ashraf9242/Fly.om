...
export const T = {
  ...
  ar: {
    ...
    about: {
      ...
      body: 'إبراهيم الغافري طيار طائرات خفيفة مرخّص، وقافز حر منافس، ومعبّئ مظلات معتمد، ومصوّر جوي محترف. مع أكثر من ٨ سنوات من الخبرة في تحليق الركاب فوق سواحل عُمان الخلّابة، أبهر إبراهيم مئات المغامرين بلحظات لا تُنسى. ',
      rolesTitle: 'المناصب',
